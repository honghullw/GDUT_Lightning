...
//----宏定义OLED引脚----	 
#define OLED_SCL_PIN			C11
#define OLED_SDA_PIN			C12
...
void	oled_p6x8str			(uint8 x,uint8 y,const int8 ch[]);                                                      //输出字符串
void	oled_p8x16str			(uint8 x,uint8 y,const int8 ch[]);
void	oled_uint16				(uint8 x, uint8 y, uint16 num);                                                  //输出uint型变量值
...
void	oled_print_chinese		(uint8 x, uint8 y, uint8 size, const uint8 *p, uint8 len);                               //输出中文
